...
export function init(container) {
        ...
        <div class="flex flex-col h-screen bg-gray-50">
            ...
            <div class="bg-blue-700 text-white p-4 shadow-lg sticky top-0 z-10">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-xl font-bold">Setor Tunai</h1>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="bg-blue-600 rounded-xl p-4 text-white mb-6 shadow-md">
                    <p class="text-blue-100 text-xs">Current Balance</p>
                    <h2 class="text-2xl font-bold" id="current-balance">Rp ...</h2>
                </div>

                <div class="bg-white rounded-xl shadow-sm p-6">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Nominal Deposit</label>
                    <div class="relative">
                        <span class="absolute left-3 top-2.5 text-gray-500 font-bold">Rp</span>
                        <input type="number" id="amount-input" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 font-bold text-lg" placeholder="0">
                    </div>
                ...
                <button id="submit-btn" class="w-full bg-blue-600 text-white font-bold py-3 rounded-lg shadow mt-6 hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed">
                    Lanjut
                </button>
            </div>
        </div>
    ...
    submitBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            const response = await API.depositBalance(amount, pin);
